...
Assert-True (@($manifest.supportedArchitectures) -contains "amd64") "manifest advertises the amd64 control target"
Assert-True (@($manifest.supportedArchitectures) -contains "arm64") "manifest advertises the arm64 target"
