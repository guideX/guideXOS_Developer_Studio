...
int main() {
    ...
    controller.stoppedContext.processId = 0;
    controller.stoppedContext.nativeRuntimeId = 77;
    controller.stoppedContext.threadId = 1;
    controller.stoppedContext.sessionGeneration = 1;
    controller.stoppedContext.stopGeneration = 1;
    controller.stoppedContext.rip = 0x401000;
    controller.stoppedContext.rsp = 0x700000;
    controller.stoppedContext.rbp = 0x700100;
