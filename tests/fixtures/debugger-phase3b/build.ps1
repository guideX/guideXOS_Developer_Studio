...
$flags = @('--target=x86_64-unknown-elf','-std=c++11','-ffreestanding','-fno-exceptions','-fno-rtti','-fno-stack-protector','-fno-unwind-tables','-fno-asynchronous-unwind-tables',"-I$SdkInclude")
...
try {
    ...
    $elfPath = Join-Path $PackageBin "debugger-phase3b.elf"
    # Developer Studio itself is resident at the default ET_EXEC base and has
    # a large static image; keep this fixture reloc-free but non-overlapping.
