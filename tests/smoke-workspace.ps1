...
try {
    ...
    & g++ -std=c++17 -Wall -Wextra -pedantic -Isrc src\developer_studio_find.cpp src\developer_studio_syntax.cpp src\developer_studio_models.cpp src\developer_studio_projects.cpp src\developer_studio_symbols.cpp src\developer_studio_workspace.cpp tests\workflow_test.cpp -o $TestBinary
